            ...
            <div class="col-4">
                ...
                <form action="../actions/Edit-action.php" method="post" enctype="multipart/form-data">
                    <div class="row justify-content-center mb-3">
                        <div class="col-6">
                            <?php
                                if($user['photo']){
                                    ?>
                                <img src="../assets/images/<?=$user['photo']?>" alt="<?=$user['photo']?>" class="d-block mx-auto edit-photo" style="width: 3em; height: 3em; object-fit: cover;">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn-warning btn-sm px-5">Save</button>
                    </div>
